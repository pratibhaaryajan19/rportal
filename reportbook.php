...
$q=mysqli_query($conn,"select title_manu, authors from socs_bookchap where YEAR(pubdate) =YEAR(CURDATE()) AND  department in (select department from socs_loginnew where sap_id='$uname')");
$c=mysqli_num_rows($q);
...
<body>
<div>
<div  class="container"> <br>BOOK CHAPTERS Report-YEAR[<?php echo date('Y'); ?>]</div><br>
