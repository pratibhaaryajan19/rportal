...
<div class="home-block clearfix">
          <div class="features clearfix">
		   ...
		   <div class="fbox">
            ...
            <div class="fbox-text">View your Complete Research Data Submitted </div>
           </div>
...
<div class="home-block clearfix">
          <div class="features clearfix">
		   ...
		   <div class="fbox">
            <a href="schtarget.php"><div class="fbox-head">Set School Level Targets<br /><br /></div>           
            <img src="resources/pics/view.jpg" alt="" /></a>
            <div class="fbox-text">Set Departmental Targets for the school </div>
           </div>
           <div class="fbox">
            <a href="departprogress.php"><div class="fbox-head">View Target Achieved</div><br>           
            <img src="resources/pics/transport.png" alt="" /></a>
            <div class="fbox-text" style="text-align:left">View Achieved Targets by individual departments</div>
           </div>
...
<div class="home-block clearfix">
          <div class="features clearfix">
           <div class="fbox">
            <a href="comparison.php"><div class="fbox-head">Comparisons<br /><br /></div>         
            <img src="resources/pics/stack.jpg" alt=""  /></a>
            <div class="fbox-text">See Comparison Details of all the departments </div>
           </div>
...
<footer><div  id="footer" style="background-color:#3e3c3a; height:60px; color:#FFFFFF; text-align:center; font-family:calibri; width:100%">Design & Developed by <br> UPES, Dehradun</div></footer>
</body>
</html>